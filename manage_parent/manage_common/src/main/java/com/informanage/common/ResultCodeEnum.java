...
public enum ResultCodeEnum {
    ...
    LOGIN_PHONE_ERROR(false, 28009, "手机号码格式不正确"),
    LOGIN_Email_ERROR(false, 28012, "邮箱格式不正确"),
    ...
    REGISTER_EMAIL_ERROR(false, 280013, "邮箱已被注册"),
    LOGIN_AUTH(false, 28004, "需要登录"),
    LOGIN_ACL(false, 28005, "没有权限"),
    EMAIL_SEND_ERROR(false, 28011, "邮件发送失败"),
