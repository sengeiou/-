...
<div class="camera_outer" style="margin-left:30%">
    ...
    <div class="button" >
      ...
      <el-button @click="setImage()">点击注册</el-button>
    </div>
    <div>
...
export default {
  ...
  if(_this.thisContext==null){
    ...
    axios.post("http://192.168.110.149:7002/userservice/user/registByFace"
     //"http://localhost:7002/userservice/user/registByFace"
    , param, config).then(res => {
     // 提示发送成功
        ...
        if(res.data.success==true){
          // 跳转到网站的首页面
          setTimeout(function () {
     window.location.href = '/login/face_login'//1秒后刷新页面
      }, "1000");
